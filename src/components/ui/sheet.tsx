      ...
      <SheetViewport side={side} variant={variant}>
        <SheetPrimitive.Popup
          className={cn(
            ...
            variant === 'inset' &&
              'before:hidden sm:rounded-2xl sm:border-[2px] sm:before:rounded-[calc(var(--radius-2xl)-1px)] sm:**:data-[slot=sheet-footer]:rounded-b-[calc(var(--radius-2xl)-1px)] border-border',
            className,
          )}
